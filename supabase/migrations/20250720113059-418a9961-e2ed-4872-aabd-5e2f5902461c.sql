...
CREATE POLICY "Business owners and super_admin can manage WhatsApp sessions"
  ON public.whatsapp_sessions
  FOR ALL
  USING (
    EXISTS (
      SELECT 1 FROM public.businesses b
      WHERE b.id = whatsapp_sessions.business_id
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_sessions_business_id 
